...
<li className="nav-item">
 <a className="nav-link active text-font" aria-current="page" href="/user">Register</a>
</li>
<li className="nav-item ">
 <a className="nav-link active text-font" aria-current="page" href="/showuser">Show</a>
</li>
<li className="nav-item">
